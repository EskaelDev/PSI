...
namespace SyllabusManager.Logic.Services
{
    ...
    {
        public SyllabusService(SyllabusManagerDbContext dbContext, UserManager<SyllabusManagerUser> userManager) : base(
        ...
        public async Task<bool> Pdf(Guid id)
        {
            ...
            Dictionary<LearningOutcomeCategory, int> lods = (await _dbContext.LearningOutcomeDocuments
